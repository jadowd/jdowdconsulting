...
$BAW_MES += array(
    ...
    'libraryfiles' =>
        ...
        . "dass PHP diesen Ordner lesen kann.",
    'configwrite' =>
        "Die Konfigurations-Datei ist nicht überschreibbar. Bitte stellen Sie sicher,"
        . "dass PHP diese Datei überscreiben kann oder bearbeiten Sie diese Datei mit"
        . "einem geeigneten Editor anstelle das Online-Formular zu verwenden.",
    'configread' =>
        "Die Konfigurations-datei konnte nicht zum lesen geöffnet werden.",
    'configdisabled' =>
        "Das Online-Konfigurations-Formular wurde blockiert. Um es zu verwenden, "
        ."setzen Sie bitte \$BAW_CONF['online_config'] = true in der config.php",
    'libraryeval' =>
    ...
    'password_match' =>
        'The passwords you have entered do not match. Please go back and try again.',
    'password_change' =>
        'You are trying to use the default password. Please go back change to a '
        . 'different password',
    'password_short' =>
        'Your password has to have a minimum of 6 characters. Please go back and'
    ...
    'cfg_aws_icons_url_hlp' => 'Die URL zu den AWStats Icons. Inclusive http://... '
        . "Kein '/' am Ende.",
    'cfg_web_config' => 'Web Konfiguration',
    'cfg_web_config_hlp' => 'Wollen Sie das Web-Frontend zur Konfiguration verwenden? '
        . 'ACHTUNG: hierfür muss die config.php beschreibbar sein. Dies ist generell '
        . 'ein SICHERHEITSRISIKO wenn die BetterAWStats-installation nicht '
        . 'durch ein .htaccess-file o.ä. passwortgeschützt ist.',
    'cfg_web_config_pw' => 'Ändere Konfigurations-Password?',
    'cfg_web_config_pw_hlp' => 'Dieses Passwort wid gebraucht um die online-'
        . 'Konfiguration zu benutzen. Es muss länger als 5 Buchstaben sein.',
    ...
    // display_helpers
    'config_not_writable' => 'Konfigurationsfile ist nicht schreibbar!',
    'config_editor' => 'Konfigurations-Interface',
    'created_by' => 'erstellt von %s',
    'config_intro' => "// ACHTUNG:\r\n// BetterAWstats hat ein online Konfigurations-Interface "
        . "mit dem Sie die einstellungen mit dem Browser ändern können. Der "
        . "Link dazu befindet sich unten im Menu! Um diesen zu verwenden, muss "
        . "\$BAW_CONF['online_config']= true; gestellt werden, und diese Datei "
        . "muss für den Server beschreibbar sein.",
    'cfg_name' => 'NAME:   ',
    'cfg_info' => 'INFO:   ',
    'cfg_def'  => 'STANDART:',
    'cfg_display' => 'ANZEIGE',
    'cfg_display2' => 'Statistik Anzeige',
    'cfg_logout' => 'Ausloggen',
    'confirm_password' => 'Password bestätigen: ',
    'cfg_saved' => "Die Konfiguration wurde gespeichert. Weiter zu den "
        . "<a href=\"{$BAW_CONF['site_url']}/\">Statistiken</a> oder zurück zum "
        . "<a href=\"{$BAW_CONF['site_url']}/index.php?action=config_editor\">"
        . "Konfigurations-Interface</a>.",
    'cfg_save' => 'Alles Speichern',
    'cfg_reset' => 'Zurücksetzen',
    'cfg_exit' => 'Ende',
    'cfg_asc'=> 'Ausfteigend',
    'cfg_desc' => 'Absteigend',
    'show' => 'Anzeigen',
    ...
    // config.inc.php
    'require_password' => 'Please enter the password and press OK.',
