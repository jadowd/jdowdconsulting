...
$BAW_MES += array(
    ...
    'libraryfiles' =>
        ...
        . "that php has read-permissions on that folder.",
    'configwrite' =>
        "The configuration file is not writable. Please make sure that the script "
        . "can write to the file or simply edit the file directly on the server "
        . "instead of using the configuration Editor.",
    'configread' =>
        "The config file could not be opened for read/write access",
    'configdisabled' =>
        "The online configurator has been disabled. Please set "
        . "\$BAW_CONF['online_config'] = true in your config.php",
    'libraryeval' =>
    ...
    'cfg_web_config' => 'Web Configuration',
    'cfg_web_config_hlp' => 'Enable the online configuration editor? WARNING: '
        . 'Your config.php has to be writable in order to enable this. This is '
        . 'a BAD idea to use unless the folder is password-protected with a '
        . '.htaccess file or similar.',
    'cfg_web_config_pw' => 'Change configuration password?',
    'cfg_web_config_pw_hlp' => 'This password is needed to access the online '
        . 'configuration. It has to be longer than 5 letters.',
    ...
    // display_helpers
    'config_not_writable' => 'Configuration file not writable!',
    'config_editor' => 'Configuration Editor',
    'created_by' => 'created by %s',
    'config_intro' => "// ATTENTION: BetterAWstats has an online config "
        . "editor that you can use instead of editing this file here. The link "
        . "is on the bottom of the menu! To use it, set \$BAW_CONF['online_config']"
        . "= true; and make sure that the file is writable by the server, AND protect"
        . "the BetterAWStats installation by a .htaccess file!",
    'cfg_name' => 'NAME:   ',
    'cfg_info' => 'INFO:   ',
    'cfg_def'  => 'DEFAULT:',
    'cfg_display' => 'DISPLAY',
    'cfg_display2' => 'Stats Display',
    'cfg_logout' => 'Log Out',
    'confirm_password' => 'Confirm Password: ',
    'cfg_saved' => "The configuration has been saved. Continue to the "
        . "<a href=\"{$BAW_CONF['site_url']}/\">Statistics</a> or go back to the "
