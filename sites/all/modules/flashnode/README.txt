...
settings. Note - some of the new permissions DISABLE features when activated so
be wary of activating every flash node permission as it may have the opposite
effect to that which you expect!
